#pragma once
#include "stdafx.h"
#include "Samples/GraphMatrix.h"
#include "Samples/arrayVector.h"

BEGIN_TEST(TestGraphMatrix)
		typedef GraphMatrix<int, 30> TGraph;
		TGraph graph;
		...
		GraphMatrixPrintHelpers::PrintMatrix( graph );
		GraphMatrixPrintHelpers::Print( graph );
