...
#include "samples/3.Synchronizing/1.ConditionVariable.h"
#include "samples/3.Synchronizing/2.ThreadsafeQueue.h"
#include "samples/3.Synchronizing/3.Future.h"
#include "samples/3.Synchronizing/4.PackageTask.h"
#include "samples/3.Synchronizing/5.Promise.h"
#include "samples/3.Synchronizing/6.SharedFuture.h"

#include "samples/4.SafeDataStructures/ThreadSafeList.h"
#include "samples/4.SafeDataStructures/ThreadSafeLookupTable.h"
#include "samples/4.SafeDataStructures/ThreadSafeQueue.h"
#include "samples/4.SafeDataStructures/ThreadSafeStack.h"

#include "samples/5.ThreadFindAlgorithms/ParallelFind.h"
#include "samples/5.ThreadFindAlgorithms/ParallelForEach.h"
#include "samples/5.ThreadFindAlgorithms/ParallelQuickSort.h"
#include "samples/CumulValueThreads.h"
...
int main()
{
	...
	Ex30::Ex30_CumulValueThreads().Run();
}